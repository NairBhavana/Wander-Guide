...
const styles = StyleSheet.create({
  calendarContainer: {
    ...
    margin: 15,
    borderRadius: 20,
    paddingTop: 3, // Maintains space for header
    paddingBottom: 2, // Reduced from 5 to 2 to minimize bottom space
    paddingHorizontal: 0,
    shadowColor: '#000',
  ...
  dayCell: {
    ...
    alignItems: 'center',
    marginVertical: 1, // Reduced from 1 to 0 to eliminate extra row spacing
  },
  dayText: {
    fontSize: 10,
    color: '#fff',
